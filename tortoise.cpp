...
{	//CHECK 이미지
	//==========추가 이미지
	IGM->addFrameImage("거북이_페이즈1_레디", "Texture/Enemies/Boss1/bossReady_975x492_5x2.bmp", 975, 492, 5, 2);
	...
	IGM->addFrameImage("거북이_죽음폭발이펙트", "Texture/Effect/enemyBossExplode_1600x151_7x1.bmp", 1600, 151, 7, 1);
